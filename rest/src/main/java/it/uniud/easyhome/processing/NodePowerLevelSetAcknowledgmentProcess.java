...
public class NodePowerLevelSetAcknowledgmentProcess extends Process {
    ...
    public NodePowerLevelSetAcknowledgmentProcess(int pid, UriInfo uriInfo,ProcessKind kind, LogLevel logLevel) throws NamingException, JMSException {
	...
	protected void process() throws JMSException, NamingException {
    	...
    	if (msg != null) {
        	...
        	if (NodePowerLevelSetAcknowledgmentPacket.validates(pkt)) {
	        	log(LogLevel.FINE, "NodePowerLevelSetAcknowledgmentPacket received from " + pkt.getSrcCoords());
	        	...
	        	try {
		        		...
		        		synchronized(nodesLock) {
			        		...
			        		if (getResponse.getClientResponseStatus() == ClientResponse.Status.OK) {
				                ...
				                if (updateResponse.getClientResponseStatus() == Status.OK) {
				                	...
				                	log(LogLevel.FINE, node + " power level information insertion failed");
				        	} else
	        		...
	        		log(LogLevel.FINE, "No corresponding power level set issue job found: acknowledgment ignored");
