...
public class NodeDescrRegistrationProcess extends Process {
    ...
    public NodeDescrRegistrationProcess(int pid, UriInfo uriInfo, ProcessKind kind, LogLevel logLevel) throws NamingException, JMSException {
	...
	protected void process() throws JMSException, NamingException {
    	...
    	if (msg != null) {
        	...
        	if (NodeDescrRspPacket.validates(pkt)) {
	        	log(LogLevel.FINE, "NodeDescrRspPacket received from " + pkt.getSrcCoords());
		                ...
		                if (nodeResponse.getClientResponseStatus() == ClientResponse.Status.OK) { 
		                	if (updateResponse.getClientResponseStatus() == ClientResponse.Status.OK) {
			                    ...
			                    try {
			                    	...
			                    	log(LogLevel.FINE, "Descriptor acquisition event dispatch failed");
			                    }
			                	...
			                	log(LogLevel.FINE, "Node " + node + " logical type information and manufacturer update failed");
	        			} else 
