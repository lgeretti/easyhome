...
public class NodePowerLevelRequestProcess extends Process {
    ...
    public NodePowerLevelRequestProcess(int pid, UriInfo uriInfo,ProcessKind kind, LogLevel logLevel) throws NamingException, JMSException {
	...
	protected void process() throws JMSException, NamingException {
		...
		ClientResponse jobListResponse = restResource.path(RestPaths.JOBS).queryParam("type", NetworkJobType.NODE_POWER_LEVEL_REQUEST.toString())
        		.accept(MediaType.APPLICATION_JSON).get(ClientResponse.class);
		try {
